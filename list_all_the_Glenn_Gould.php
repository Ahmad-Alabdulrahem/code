<html>
<head>
	<title>List all the Glenn Gould recordings</title>
</head>

<body>
	<h3>List all the Glenn Gould recordings</h3>
	<hr>
...
<?php
	...
	$query = "SELECT composition.comp_name FROM composition JOIN comp_cd ON composition.comp_id = comp_cd.comp_id JOIN cd ON comp_cd.CD_NR = cd.CD_NR WHERE cd.Performer = 'Glenn Gould'";
