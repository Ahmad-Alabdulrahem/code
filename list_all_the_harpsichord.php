<html>
<head>
	<title>list all the harpsichord pieces in the library</title>
</head>

<body>
	<h3>List all the harpsichord pieces in the library</h3>
	<hr>
...
<?php
	...
	$query = "SELECT composition.comp_name FROM composition WHERE composition.comp_id IN ( SELECT comp_cd.comp_id FROM comp_cd WHERE comp_cd.Instrument = 'harpsichord')";
	...
	echo "<P>antal: " . mysqli_num_rows($result) . " Harpsichord pieces!\n </P>";
