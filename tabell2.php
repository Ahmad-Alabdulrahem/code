...
<?php
	...
	$query = "SELECT name, comps_id FROM composer";
...
<br><br>
  ...
  <table border="1">
    <tr>
      <th bgcolor=#eeeeee style='width: 200px;'>name</th>
      <th bgcolor=#eeeedd style='width: 200px;'>comps_id</th>
    </tr>
...
while (list($name, $comps_id) = mysqli_fetch_row($result))
{
        echo "<tr>";
	echo "<td bgcolor=#aaaaaa>" . $name . "</td>";
