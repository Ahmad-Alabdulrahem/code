...
<?php
	...
	$query = "SELECT comp_id, comp_name, BWV_nr, comps_id, lyrics_wri FROM composition";
...
<br><br>
  ...
  <table border="1">
    <tr>
      ...
      <th bgcolor=#eeeedd style='width: 200px;'>comp_name</th>
      <th bgcolor=#eeeeee style='width: 200px;'>BWV_nr</th>
      <th bgcolor=#eeeeee style='width: 200px;'>comps_id</th>
      <th bgcolor=#eeeeee style='width: 200px;'>lyrics_wri</th>
    </tr>
...
while (list($comp_id, $comp_name, $BWV_nr, $comps_id, $lyrics_wri) = mysqli_fetch_row($result))
{
        echo "<tr>";
	echo "<td bgcolor=#aaaaaa>" . $comp_id . "</td>";
	echo "<td bgcolor=#aaaaaa>" . $comp_name . "</td>";
	echo "<td bgcolor=#aaaaaa>" . $BWV_nr . "</td>";
    echo "<td bgcolor=#aaaaaa>" . $comps_id . "</td>";
    echo "<td bgcolor=#aaaaaa>" . $lyrics_wri . "</td>";
      echo "</tr>";
}
